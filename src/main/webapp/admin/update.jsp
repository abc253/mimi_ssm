		...
		<div id="addAll">
			...
			<script type="text/javascript">
				function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
					...
					$.ajaxFileUpload({
						url: '/mimi/prod/ajaxImg.action',//用于文件上传的服务器端请求地址
...
<script type="text/javascript">
	function myclose(ispage) {
		alert(ispage)
		window.location="${pageContext.request.contextPath}/prod/recover.action?page="+ispage;
		//window.close();
	}
</script>
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<table>
						...
						<tr>
							...
							<td>
								<input type="reset" value="取消" class="btn btn-default" onclick="myclose(${updateVo.page})">
							</td>
						</tr>
					</table>
				</form>
